...
```
cd existing_repo
git remote add origin https://gitlab.ewi.tudelft.nl/bpahrens/ct.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ewi.tudelft.nl/bpahrens/ct/-/settings/integrations)
